...
* 对外提供注册推送信息处理的回调函数。 \n
* @param [IN]   USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo       用户登录信息
* @param [IN]   CALL_BACK_PROC_PF_V2     pfnCallBackProc         回调函数处理指针
* @param [IN]   VOID *pClientParam        回调使用信息
* @return ULONG_32  返回如下结果:
* - 成功：ERR_COMMON_SUCCEED
* - 失败：
* -     返回操作结果码，见各个组的错误码文件。
* @note 无
*/
IMOS_EXPORT ULONG_32 STDCALL IMOS_RegCallBackPrcFuncV2
(
    IN USER_LOGIN_ID_INFO_S     *pstUserLoginIDInfo,
    IN CALL_BACK_PROC_PF_V2        pfnCallBackProc,
    IN VOID *pClientParam
);
...
* @note 无
*/
IMOS_EXPORT ULONG_32 STDCALL IMOS_QueryOnvifStreamCFG
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  CHAR                    szOnvifCode[IMOS_CODE_LEN],
    OUT ONVIF_STREAM_CFGS_S     *pstOnvifStreamCFG
);
...
* @note 无
*/
IMOS_EXPORT ULONG_32 STDCALL IMOS_SetOnvifStreamCFG
(
    IN  USER_LOGIN_ID_INFO_S    *pstUserLogIDInfo,
    IN  ONVIF_STREAM_CFGS_S     *pstOnvifStreamCFG
);
...
*/
IMOS_EXPORT ULONG STDCALL IMOS_SetNetworkInfo
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLogIDInfo,
...
* @return       ERR_COMMON_SUCCEED  表示成功，失败返回请见错误码
*/
IMOS_EXPORT ULONG STDCALL IMOS_GetNetworkInfo
(
    IN  USER_LOGIN_ID_INFO_S        *pstUserLogIDInfo,
