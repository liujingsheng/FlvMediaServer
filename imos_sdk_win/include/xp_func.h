...
/* Begin: Add by chenliang w0897, 2014/7/1, 设置多个上报错误信息的回调函数 */
IMOS_EXPORT ULONG_32 STDCALL IMOS_SetMultRunMsgCB(IN XP_RUN_INFO_CALLBACK_EX_PF *pfnRunInfoFunc);
/* End: Add by chenliang w0897, 2014/7/1, 设置多个上报错误信息的回调函数 */
...
* @note 无。
*/
IMOS_EXPORT ULONG_32 STDCALL IMOS_GetChannelCode(IN const USER_LOGIN_ID_INFO_S *pstUserLoginIDInfo,
                                                                                   OUT CHAR *pcChannelCodel);
...
* @note 无。
*/
IMOS_EXPORT VOID STDCALL IMOS_FreeChannelCode(IN const USER_LOGIN_ID_INFO_S *pstUserLoginIDInfo,
                                                                                IN const CHAR *pcChannelCodel);
